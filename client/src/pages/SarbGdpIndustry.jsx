...
const SarbGdpIndustry = () => {
  ...
  const economicSectors = [economicSectorsCurrent, economicSectorsPrevious];
    ...
    <div>
      <div className="grid grid-cols-1 gap-4 p-8">
        <div className="p-4 border rounded shadow">
          ...
          <div className="flex">
            {economicSectors.map((data, index) => (
        ...
        <div className="italic text-xs text-muted-foreground">
          *Total Value Added at Basic Prices represents the GDP generated by
          each sector or industry, reflecting the value of goods and services
          produced within an economy, excluding taxes and including subsidies on
          products.
          <br />
          <br />
          Total Value Added at Basic Prices ={" "}
